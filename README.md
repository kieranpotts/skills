...
These skills cover universal phases of the software development lifecycle – specifying, designing, planning, branching, coding, committing, testing, reviewing, merging, releasing – plus cross-cutting concerns like customer discovery, issue triage, session reflection, and agent handoff. The goal: consistent, predictable outputs from any mainstream coding agent and model, regardless of technology stack or business domain.
