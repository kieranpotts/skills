...
It runs non-interactively and stops at the edits: it does **not** branch, commit, or open PRs, so you can proofread on any branch and commit on your own terms. It reports a per-file summary of what changed (🤖).
