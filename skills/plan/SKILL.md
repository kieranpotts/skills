...
independently deployable steps. Each step is testable, reversible, and shippable
on its own.

Planning only. You MUST NOT make any code or configuration changes to the software
itself.
