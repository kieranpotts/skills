...
hosts that do not understand it simply ignore it.

My [`realize`](https://github.com/kieranpotts/pi) extension for Pi uses this
metadata to toggle the model used to run a skill.
