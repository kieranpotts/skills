...
and sensors](https://martinfowler.com/articles/harness-engineering.html).
...
Sensors themselves come in two categories — [deterministic
sensors](./deterministic-sensors.md) and [inferential
sensors](./inferential-sensors.md) — and both guides and sensors need to be
[calibrated](./calibration.md) to the fragility of the task they constrain.
