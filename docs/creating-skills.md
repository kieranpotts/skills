...
See also [best practices](./best-practices.md) for the design principles behind a good skill — single responsibility, when a skill is worth adding, synchronous vs. asynchronous execution, and hand-off design.
